...
export default async function ProjectQuotationPage({ params }) {
    ...
    const designsForQuote = project.designs.map((dbDesign) => ({
        id: dbDesign.id,
        name: dbDesign.name,
        parameters: {
    ...
    return (<ProjectQuotation partyInfo={partyInfo} designs={designsForQuote} // Casting, as it has the required fields for the component.
    />);
}
