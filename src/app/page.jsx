...
export default async function LandingPage() {
    ...
    return (<PublicLayout>
        ...
        {latestQuote && (<section id="latest-quote" className="py-20 sm:py-32 bg-muted">
            ...
            <div className="container px-4 md:px-6">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative h-96">
                       {featureImage && <Image src={featureImage.imageUrl} alt={featureImage.description} fill className="rounded-xl object-cover shadow-2xl" data-ai-hint={featureImage.imageHint}/>}
                    </div>
                </div>
            </div>
        </section>
