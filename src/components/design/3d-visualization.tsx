                ...
                {frames.map(frame => {
                    ...
                    return (
                        <group 
                            ...
                            onPointerOver={(e) => { if (isOperable && e.nativeEvent.target instanceof HTMLElement) e.nativeEvent.target.style.cursor = 'pointer'; }}
                            onPointerOut={(e) => { if (isOperable && e.nativeEvent.target instanceof HTMLElement) e.nativeEvent.target.style.cursor = 'auto'; }}
                        >
